/*@lineinfo:filename=DESCUENTO*//*@lineinfo:user-code*//*@lineinfo:1^1*/package entidades;
...
public class DESCUENTO implements ORAData, ORADataFactory
{
  ...
  protected static int[] _sqlType =  { 12,2006,2,2,2 };
  ...
  { _struct.setAttribute(0, discounttype); }
  ...
  { _struct.setAttribute(1, refStor); }
  ...
  { _struct.setAttribute(3, highqty); }
  ...
  { _struct.setAttribute(4, discount); }
...

{
  ...
  try {
   ...
   // set IN parameters
   if (__jPt_temp==null) __sJT_st.setNull(1,2002,"PUBS.DESCUENTO"); else __sJT_st.setORAData(1,__jPt_temp);
  // execute statement
...

{
  ...
  try {
   ...
   if (REF_STOR==null) __sJT_st.setNull(3,2006,"PUBS.TIENDA"); else __sJT_st.setORAData(3,REF_STOR);
...
/*@lineinfo:user-code*//*@lineinfo:231^5*/
...

{
  ...
  try {
   ...
   // set IN parameters
   if (__jPt_temp==null) __sJT_st.setNull(2,2002,"PUBS.DESCUENTO"); else __sJT_st.setORAData(2,__jPt_temp);
  // execute statement
   __sJT_ec.oracleExecuteUpdate();
   // retrieve OUT parameters
...
/*@lineinfo:user-code*//*@lineinfo:267^5*/
   ...
   try {
      ...
      closeConnection();
      if (__dataSource==null) throw _err;
    /*@lineinfo:generated-code*//*@lineinfo:273^5*/
...
/*@lineinfo:user-code*//*@lineinfo:277^5*/
   } catch (java.sql.SQLException _err2) { 
     try { getConnectionContext().getExecutionContext().close(); } catch (java.sql.SQLException _sqle) {}
     throw _err; 
  }
