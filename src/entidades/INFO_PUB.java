/*@lineinfo:filename=INFO_PUB*//*@lineinfo:user-code*//*@lineinfo:1^1*/
...
public class INFO_PUB implements ORAData, ORADataFactory {
  ...
  protected MutableStruct _struct;
    ...
    protected static int[] _sqlType = {2, 2006, 2004, 2005};
    protected static ORADataFactory[] _factory = new ORADataFactory[4];

    static {
        _factory[1] = EDITORIALRef.getORADataFactory();
    }
    ...
    protected void setValueFrom(INFO_PUB o) {
        _struct = o._struct;
    }
    ...
    public void setPrInfo(oracle.sql.CLOB prInfo) throws SQLException {
        _struct.setOracleAttribute(3, prInfo);
    }
...
//  ************************************************************

            {
                ...
                try {
                    ...
                    // set IN parameters
                    if (__jPt_temp == null) {
                        __sJT_st.setNull(1, 2002, "PUBS.INFO_PUB");
                    } else {
...
//  ************************************************************
            ...
            /*@lineinfo:user-code*//*@lineinfo:186^15*/
        } catch (java.sql.SQLException _err) {
            try {
                getConnectionContext().getExecutionContext().close();
                closeConnection();
...
//  ************************************************************

            {
                ...
                try {
                    ...
                    // set IN parameters
                    if (__jPt_temp == null) {
                        __sJT_st.setNull(2, 2002, "PUBS.INFO_PUB");
                    } else {
...
//  ************************************************************
            ...
            /*@lineinfo:user-code*//*@lineinfo:212^5*/
        } catch (java.sql.SQLException _err) {
            try {
                getConnectionContext().getExecutionContext().close();
                closeConnection();
...
//  ************************************************************

            {
                ...
                try {
                    ...
                    // set IN parameters
                    if (REF_PUB == null) {
                        __sJT_st.setNull(2, 2006, "PUBS.EDITORIAL");
                    } else {
                        __sJT_st.setORAData(2, REF_PUB);
                    }
...
//  ************************************************************
            ...
            try {
                ...
                /*@lineinfo:generated-code*//*@lineinfo:285^5*/
