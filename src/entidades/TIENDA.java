/*@lineinfo:filename=TIENDA*//*@lineinfo:user-code*//*@lineinfo:1^1*/package entidades;
...
public class TIENDA implements ORAData, ORADataFactory
{
  ...
  protected static int[] _sqlType =  { 1,12,12,12,1,1 };
  ...
  { _struct.setAttribute(1, storName); }
  ...
  { _struct.setAttribute(2, storAddress); }
...

{
  ...
  try {
   ...
   // set IN parameters
   if (__jPt_temp==null) __sJT_st.setNull(1,2002,"PUBS.TIENDA"); else __sJT_st.setORAData(1,__jPt_temp);
  // execute statement
...
/*@lineinfo:user-code*//*@lineinfo:182^5*/
    return __jPt_temp;
...
/*@lineinfo:user-code*//*@lineinfo:198^14*/
 } catch(java.sql.SQLException _err) {
   try {
      getConnectionContext().getExecutionContext().close();
      closeConnection();
...
/*@lineinfo:user-code*//*@lineinfo:205^14*/
   } catch (java.sql.SQLException _err2) { 
     try { getConnectionContext().getExecutionContext().close(); } catch (java.sql.SQLException _sqle) {}
     throw _err; 
  }
...

{
  ...
  try {
   ...
   // set IN parameters
   if (__jPt_temp==null) __sJT_st.setNull(2,2002,"PUBS.TIENDA"); else __sJT_st.setORAData(2,__jPt_temp);
  // execute statement
   __sJT_ec.oracleExecuteUpdate();
   // retrieve OUT parameters
...
/*@lineinfo:user-code*//*@lineinfo:224^5*/
 } catch(java.sql.SQLException _err) {
   try {
      getConnectionContext().getExecutionContext().close();
      closeConnection();
...
/*@lineinfo:user-code*//*@lineinfo:264^5*/
  ...
  throws java.sql.SQLException
  {
    ...
    TIENDA __jPt_result;
 try {
    /*@lineinfo:generated-code*//*@lineinfo:286^5*/
